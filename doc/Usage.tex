...
\subsection{\texorpdfstring{\protect\ai[\tt]{barvinok\_series}}
{barvinok\_series}}
...
of $P$ by a factor $n$.
The input is the same as that of \ai[\tt]{barvinok\_count}.
The functionality is the same as running \ai[\tt]{barvinok\_enumerate}
(or \ai[\tt]{barvinok\_series} if the \ai[\tt]{--series} option was given)

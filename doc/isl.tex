...
The constraints also need to be given in \indac{DNF}, with disjuncts
separated by the \ai[\tt]{or} keyword and conjuncts separated
by the \ai[\tt]{and} keyword.
